...
ZPPJSON_DEFINE_TYPE(
    ...
    /**
    \brief whether immunity should be stored as allele level instead of gene level.
...
ZPPJSON_DEFINE_TYPE(
    ...
    */
    ...
    /**
        \brief How often, in simulation time units, to store a full snapshot of the system state.
    */
    ( (Double)(checkpointPeriod) )
    
    /**
        \brief Checkpoint filename to write to every checkpointPeriod.
    */
